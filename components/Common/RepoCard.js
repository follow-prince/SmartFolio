...
const RepoCard = props => {
    return (
        <a href={props.url} target='_blank' className="box flex flex-col px-4  text-left  border-2 border-[#9b9a9a80] p-3  rounded-[10px] shadow-lg dark:hover:bg-gray-700/50 hover:bg-white transition-all duration-300 ease-in-out">
