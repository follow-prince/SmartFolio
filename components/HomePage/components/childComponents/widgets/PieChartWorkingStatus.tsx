...
const PieChartWorkingStatus: React.FC = React.memo(() => {
...
PieChartWorkingStatus.displayName = 'PieChartWorkingStatus'

export { PieChartWorkingStatus }
