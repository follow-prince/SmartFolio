  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 dark:bg-slate-800/80 bg-slate-200/90   px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
      >
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        "flex flex-1 justify-between gap-1.5",
                        nestLabel ? "items-end" : "items-center"
                      )}
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span style={{color: item.payload.fill}} className="font-black ">
                          {itemConfig?.label || item.name}
                        </span>
                      </div>
                      {item.value && (
                        <span  style={{color: item.payload.fill}} className={` font-black text-lg`}>
