...
const SupaComments = () => {
  ...
  return (
    <>
      ...
      <div className='hidden w-8 w-10 h-8 h-10 mt-2 mt-10 space-y-4 rounded-full' />
      <div className='flex-1 hidden w-20 h-2 grid-cols-3 col-span-1 col-span-2 gap-4 space-x-4 rounded animate-pulse' />
      <div
        id='comments'
        data-url={BLOG.link.split('/').slice(4) || 'localhost:3000'}
