...
const BlogPost = ({ post }) => {
  return (
    <motion.div>
      ...
      >
        <div class='absolute -inset-1 bg-gradient-to-r from-red-600 dark:from-gray-600 to-violet-600 dark:to-violet-50 rounded-lg blur-lg opacity-10 group-hover:opacity-50 transition duration-1000 group-hover:duration-200'></div>
        <article
          key={post.id}
